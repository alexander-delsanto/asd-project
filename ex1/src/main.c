...
void print_record_to_file(FILE *, Record *, size_t);
...
void print_record_to_file(FILE *outfile, Record *record, size_t n_records)
{
...
void free_record(Record *record, size_t n_records)
{
...
size_t read_record(FILE *file, Record **file_record)
{
